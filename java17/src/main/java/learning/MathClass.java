...
public class MathClass {
  public static void main(String[] args) {
    ...
    // finds the largest of x and y. The answer is x because a positive is always bigger than a
    // negative.
    // double z = Math.min(x, y);
    // finds the smallest of x and y. The answer is x because a negative is always smaller than a
    // positive.
    // double z = Math.abs(y);
