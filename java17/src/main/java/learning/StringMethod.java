...
public class StringMethod {
  public static void main(String[] args) {
    ...
    // this is case sensitive. if it is yusuf it will return false since the name = Yusuf. With a
    // capital Y.
    ...
    // will print the letter at the given character. Yusuf has 5 character. The computer counts from
    // 0.
