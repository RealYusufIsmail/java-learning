...
public class OverloadedConstructors {
  public static void main(String[] args) {
    ...
    Pizza pizza = new Pizza("Thin crust", "Cornflour oil", "Mozzarella", "Tomato sauce", "Meat");

    Pizza cheese_pizza = new Pizza("Thin crust", "Cornflour oil", "Mozzarella", "Tomato sauce");
