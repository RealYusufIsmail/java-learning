...
public class Labels {
  public static void main(String[] args) {
    ...
    ImageIcon image = new ImageIcon(
        "/Users/YusufIsmail/Documents/GitHub/java8-learning/java/learning/src/com/yusuf/learning/labels/logo.png");
    ...
    label.setHorizontalAlignment(JLabel.CENTER); // set horizontal position of icon + text within
                                                 // label.
