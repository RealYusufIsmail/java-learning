...
public class Catalogs extends TableImpl<Record> {
    ...
    private Catalogs(Name alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private Catalogs(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> Catalogs(Table<O> child, ForeignKey<O, Record> key) {
